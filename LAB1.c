...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	arr[0] =(int*) malloc( length * sizeof( int ) ); //количество единиц
	arr[1] =(int*) malloc( length * sizeof( int ) ); //числа
	...
	for(step = length / 2 ; step > 0 ; step /= 2)   //сортировка количества единиц по убыванию
	{
		int i;
	...
	amount = 0;  //количество чисел с одинаковым числом единиц в бинарном представлении
